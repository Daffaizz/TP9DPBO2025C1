...
class TabelMahasiswa extends DB
{
	...
	{
		// Query mysql untuk menambahkan data mahasiswa
	...
	{
		// Query mysql untuk mengupdate data mahasiswa
		$query = "UPDATE mahasiswa 
				  SET nim = '$nim', nama = '$nama', tempat = '$tempat', tl = '$tl', 
	...
	{
		// Query mysql untuk menghapus data mahasiswa
